...
export function PluginLockDownOverlay({
  ...
  return (
    <div className="x-absolute x-inset-0 x-flex x-flex-col x-items-center x-justify-center x-gap-4 x-overflow-hidden x-rounded-md">
      ...
      <div className="x-z-10 x-mx-4 x-text-pretty x-text-center x-text-foreground">
