...
export const PLUGINS_METADATA: CplxPluginMetadata = {
  "queryBox:languageModelSelector": {
    ...
    dependentCorePlugins: ["networkIntercept", "spaRouter", "reactVdom"],
  },
  ...
  "queryBox:slashCommandMenu:promptHistory": {
    ...
    categories: ["queryBox"],
    tags: ["slashCommand", "desktopOnly", "ui", "ux"],
    dependentDomObservers: ["coreDomObserver:queryBoxes"],
  ...
  "thread:showMessageLength": {
    ...
    routeSegment: "thread-show-message-length",
  ...
  "queryBox:spacesThreadsForceWritingMode": {
    ...
    routeSegment: "query-box-spaces-threads-force-writing-mode",
    title: "Spaces: Force Writing Mode",
    tags: ["new", "experimental", "ux"],
    description:
